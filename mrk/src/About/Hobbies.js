...
import HobbiesNavBar from "./HobbiesNavBar";
function Hobbies() {
  return (
    <div className="hobbies-container">
      ...
      <div className="hobby-section" id="disney-fan">
        ...
        <p>
          I've been to Disneyland about 200 times. Also got to visit Disney
          World many times while working in Florida. In fact, in April 2019, I
          visited all for Disney World Parks (Magic Kingdom, EPCOT, Disney
          Studios, and Animal Kingdom) in one day!
        </p>
      ...
      <div className="hobby-section" id="sports">
        ...
        <ul>
          ...
          <li>
            ...
            game while on our honeymoon, in 1986. (The year the Mets won the
            World Series!)
          </li>
        </ul>
        <h3>
        ...
        <ul>
          <li>
            Coaching in the Suns arena several times in a championship game
          </li>
          ...
          <li>
            Seeing how awesome my sons were to their teammates and friends
          </li>
        </ul>
        <h3>
